...
class EstadisticaProjectCard extends HTMLElement {
    constructor() {
        super();
    ...
    async connectedCallback() {
        ...
        this.idTarea = this.getAttribute('idTarea') || null;
        this.nombre = this.getAttribute('nombre') || 'Proyecto Desconocido';
    ...
    async fetchHoras() {
        try {
            const response = await fetch('/horas/usuario/tarea', {
            method: 'POST',
            ...
            console.log("Horas imputadas:", data);
...
customElements.define('estadisticas-project-card', EstadisticaProjectCard);